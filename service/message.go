...
func (service *MessageService) MessageAction(loginUserID uint64) error {
	...
	//database.CreateMessage(loginUserID, service.ToUserID, service.Content)
	_, err = database.RPC.ContactRpc.CreateMessage(context.TODO(), &contact.CreateMessageRequest{
		UserID:   loginUserID,
